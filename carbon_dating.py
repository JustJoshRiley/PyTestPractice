...
def get_age_carbon_14_dating(carbon_14_ratio):
    ...
    if carbon_14_ratio == 0:
        raise ValueError("Carbon 14 ratio cannot be 0")
    if carbon_14_ratio < 0:
        raise ValueError("Carbon 14 ratio cannot be negative")
    if carbon_14_ratio > 1:
        raise ValueError("Carbon 14 ratio cannot be greater than 1")
    else :
